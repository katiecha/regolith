    ...
    >
      <div className="relative z-10 max-w-xl w-full">
        ...
        <div className="space-y-6">
          ...
          <p className="text-base text-foreground">
            We&apos;ve since pivoted to Earth as our initial case study. The same
            failures — degrading sensors, repeated faults, knowledge lost at
            every shutdown — already play out in factories, robots, and
            industrial equipment, with far more data to learn from. Earth is
